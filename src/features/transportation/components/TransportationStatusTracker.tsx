...
interface TransportationStatusTrackerProps {
  status: string;
...
const TransportationStatusTracker = ({ status, updates }: TransportationStatusTrackerProps) => {
...
export default TransportationStatusTracker;
