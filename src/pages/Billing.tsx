    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Comprehensive project billing and payment tracking system</p>
        </div>
        ...
        <TabsContent value="projects" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage all billing projects with department involvement and work planning</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="payments" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track payments received and pending from project owners</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="invoices" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate professional invoices for projects</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="calculator" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Calculate project costs, payments, and outstanding amounts</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                <Calculator className="mx-auto h-12 w-12 text-muted-foreground mb-4" />
                <p className="text-muted-foreground">Billing calculator will be implemented here</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
      ...
      <Dialog open={isProjectDialogOpen} onOpenChange={setIsProjectDialogOpen}>
        <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Add New Billing Project</DialogTitle>
          </DialogHeader>
